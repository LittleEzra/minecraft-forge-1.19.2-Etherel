...
import com.littleezra.ethereal.entity.custom.SlingProjectile;
...
public class SlingProjectileRenderer extends EntityRenderer<SlingProjectile> {
    ...
    public SlingProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    public void render(SlingProjectile p_115036_, float p_115037_, float p_115038_, PoseStack p_115039_, MultiBufferSource p_115040_, int p_115041_) {
        p_115039_.pushPose();
    ...
    public ResourceLocation getTextureLocation(SlingProjectile entity) {
