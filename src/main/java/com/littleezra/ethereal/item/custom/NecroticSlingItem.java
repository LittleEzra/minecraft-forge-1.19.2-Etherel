...
public class NecroticSlingItem extends ProjectileWeaponItem {
    ...
    public static final List<Item> validItems = List.of(
            ...
            Items.FIREWORK_STAR,
            Items.COBBLESTONE,
            ModItems.ETHEREAL_CONCENTRATE.get(),
            ModItems.NECROTIC_CONCENTRATE.get(),
            ModItems.VERDANT_CONCENTRATE.get()
    );

    public static final Supplier<Map<Item, MobEffectInstance>> ITEM_EFFECTS = Suppliers.memoize(() -> {
        return ImmutableMap.<Item, MobEffectInstance>builder()
                .put(ModItems.ETHEREAL_CONCENTRATE.get(),  new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100, 1))
                .put(ModItems.NECROTIC_CONCENTRATE.get(),  new MobEffectInstance(MobEffects.WEAKNESS, 100, 0))
                .put(ModItems.VERDANT_CONCENTRATE.get(),   new MobEffectInstance(MobEffects.POISON, 200, 0))
                .build();
    });

    public static final Predicate<ItemStack> VALID_PROJECTILES = (itemStack) -> validItems.contains(itemStack);

    public NecroticSlingItem(Properties properties) {
        super(properties);
    }

    public void releaseUsing(ItemStack itemStack, Level level, LivingEntity entity, int useDuration) {
