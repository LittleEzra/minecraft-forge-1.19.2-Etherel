...
public class EtherealTorchBlock extends Block {

    protected static final int AABB_STANDING_OFFSET = 2;
    protected static final VoxelShape AABB = Block.box(6.0D, 0.0D, 6.0D, 10.0D, 10.0D, 10.0D);
    protected final Supplier<ParticleOptions> flameParticle;

    public EtherealTorchBlock(BlockBehaviour.Properties properties, Supplier<ParticleOptions> particle) {
        super(properties);
    ...
    public void animateTick(BlockState p_222593_, Level p_222594_, BlockPos p_222595_, RandomSource p_222596_) {
        ...
        p_222594_.addParticle(this.flameParticle.get(), d0, d1, d2, 0.0D, 0.0D, 0.0D);
    }
}
